...
and drives planning, dispatch and run finalization, and
[C07 reviewer, evidence and handoff](REVIEW.md) for the fresh-assessment
capability injected into D06's review routes.
